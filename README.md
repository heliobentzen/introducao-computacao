# Introdução à Computação
      ...
      **Avaliações:** 2 unidades  
      ...
      Conceitos fundamentais e pensamento computacional. Evolução da computação e arquitetura de computadores. Representação de dados e sistemas de numeração. Sistemas operacionais modernos e gerenciamento de recursos. Fundamentos de Computação em Nuvem (Cloud Computing) e infraestrutura como serviço. Introdução à Inteligência Artificial e suas aplicações computacionais. Uso prático de IA Generativa e ferramentas baseadas em LLMs como assistentes de produtividade.
      ...
      **Específicos:**
      ...
      1. **Leia o material antes da aula.** Os arquivos na pasta `conteudo/` cobrem o que será discutido em sala. Chegar com o material lido muda bastante a dinâmica da aula.
      
      2. **Faça as práticas.** Não basta ler sobre sistemas operacionais ou cloud computing — você precisa colocar a mão na massa. Os roteiros em `praticas/` são autoexplicativos e podem ser feitos no laboratório ou em casa.
      
      3. **Use ferramentas de IA como apoio, não como substituto.** Ferramentas como ChatGPT e GitHub Copilot são parte do currículo, mas entender o que elas produzem é sua responsabilidade. Copiar sem compreender não forma profissional.
      
      4. **Participe das discussões.** Computação muda rápido. Trazer referências do mercado, notícias e experiências reais agrega muito para a turma toda.
      
      5. **Versione seu trabalho.** Já que estamos em um repositório Git, use isso a seu favor: fork, clone, commite suas práticas. Isso já é uma habilidade profissional.
      ...
      - Problemas pessoais que afetem seu desempenho: converse com o professor antes da avaliação, não depois
